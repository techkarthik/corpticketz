...
import 'package:corpticketz/screens/ticket_detail_screen.dart';
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (tickets.isEmpty) return const Center(child: Text('No active tickets assigned.'));
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              'Due: ${ticket['due_date']?.substring(0, 10) ?? '-'}',
